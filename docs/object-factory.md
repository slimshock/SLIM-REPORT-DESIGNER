...
Image construction is supported, and future-facing placeholder constructors are also available:
...
`create_image(...)` creates a renderable image object. Barcode, QR code, and full table rendering are future work.
